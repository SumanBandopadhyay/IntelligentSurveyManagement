...
//            populateJobNetworkToDB();
    ...
    private static void populateWithTestData(AppDatabase db) {
        ...
        form = new Form();
        form.setFormid(1003);
        form.setClientName("Genny Smith");
        ...
        form = new Form();
        form.setFormid(1005);
        form.setClientName("Isaac Jones");
        form.setProject("Lab Setup");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid(1006);
        form.setClientName("Alex Gomes");
        form.setProject("Staircase Repairing");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid(1007);
        form.setClientName("David Williams");
        form.setProject("Drainage pipe Blockage");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid(1008);
        form.setClientName("Eliza Gomes");
        form.setProject("Earthing Maintenance");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid(1009);
        form.setClientName("Terrence Warton");
        form.setProject("Playground Maintenance");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid(1010);
        form.setClientName("Philip Taylor");
