...
public class DatabaseInitializer {
    ...
    private static void populateWithTestData(AppDatabase db) {
        Form form = new Form();
        form.setFormid((int) 1001);
        form.setClientName("Albert Brown");
        form.setProject("Maintenance on building");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid((int) 1002);
        form.setClientName("Charles Darwin");
        form.setProject("Blockage in Water Supply");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid((int) 1003);
        form.setClientName("Mathew Gomes");
        form.setProject("Monthly maintenance in Electricity wiring");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid((int) 1004);
        form.setClientName("David Wilson");
        form.setProject("Glass door instalment");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
        form = new Form();
        form.setFormid((int) 1005);
        form.setClientName("Eliza Pitt");
        form.setProject("Lab Setup");
        form.setFormStatus(DigitalFormActivity.INBOX);
        addForm(db, form);
//        form = new Form();
//        form.setFormid((int) 1006);
//        form.setClientName("Gennie Williams");
//        form.setProject("Lab Setup");
//        form.setFormStatus(DigitalFormActivity.INBOX);
//        addForm(db, form);
//        form = new Form();
//        form.setFormid((int) 1007);
//        form.setClientName("Megan Costa");
//        form.setProject("Lab Setup");
//        form.setFormStatus(DigitalFormActivity.INBOX);
//        addForm(db, form);
//        form = new Form();
//        form.setFormid((int) 1008);
//        form.setClientName("Alex Evans");
//        form.setProject("Lab Setup");
//        form.setFormStatus(DigitalFormActivity.INBOX);
//        addForm(db, form);
//        form = new Form();
//        form.setFormid((int) 1009);
//        form.setClientName("Celina Jones");
//        form.setProject("Lab Setup");
//        form.setFormStatus(DigitalFormActivity.INBOX);
//        addForm(db, form);
//        form = new Form();
//        form.setFormid((int) 1010);
//        form.setClientName("David Brown");
//        form.setProject("Lab Setup");
//        form.setFormStatus(DigitalFormActivity.INBOX);
//        addForm(db, form);
//        form = new Form();
//        form.setFormid((int) 1011);
//        form.setClientName("James Taylor");
//        form.setProject("Lab Setup");
//        form.setFormStatus(DigitalFormActivity.INBOX);
//        addForm(db, form);
