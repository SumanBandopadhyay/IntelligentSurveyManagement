...
import com.example.suman.intelligentsurveymanagement.activity.com.example.suman.intelligentsurveymanagement.dummy.SentJobsContent.SentJobsItem;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link SentJobsItem} and makes a call to the
...
public class MySentJobsFragmentRecyclerViewAdapter extends RecyclerView.Adapter<MySentJobsFragmentRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<SentJobsItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MySentJobsFragmentRecyclerViewAdapter(List<SentJobsItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
